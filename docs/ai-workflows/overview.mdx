...
<CardGroup cols={2}>
  ...
  <Card title="Quality Assurance" icon="microscope" href="/docs/ai-workflows/quality-assurance">
    Automated test generation, regression analysis, and environment validation.
  </Card>
  <Card title="Product Strategy" icon="clipboard-list" href="/docs/ai-workflows/product-strategy">
