...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/ai-workflows/development-workflow/overview"
  >
  ...
  <Card 
    ...
    href="/docs/ai-workflows/quality-assurance"
  >
  ...
  <Card 
    ...
    href="/docs/ai-workflows/product-strategy"
  >
...
- [Get Started with Development Workflows](/docs/ai-workflows/development-workflow/overview)
