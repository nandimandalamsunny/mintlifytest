...
<Tabs>
  <Tab title="Direct Integration">
    ...
    <Steps>
      <Step title="Initialize Connection">
        ...
        <img src="/docs/image-v2/integrations/github-1.png" width="400" />
      </Step>
      <Step title="Authorize Access">
        Authorize Revolte to access your repositories and manage automated workflows.
        <img src="/docs/image-v2/integrations/github-2.png" width="500" />
      </Step>
    </Steps>
  ...
  <Tab title="Personal Access Token">
    ...
    <img src="/docs/image-v2/integrations/github-3.png" width="400" />
