...
Standalone AI assistants (like Cursor or Codium) excel at helping individual developers write code or summarize files. Revolte is built to orchestrate the entire software delivery process.
...
<CardGroup cols={3}>
  ...
  <Card title="Workflows" icon="workflow" href="/docs/ai-workflows/overview">
    Explore AI Workflows
  </Card>


  <Card title="Configuration" icon="file-text" href="/docs/yaml/overview">
