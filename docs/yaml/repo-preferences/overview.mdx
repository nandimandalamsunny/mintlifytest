...
- [Map your first branch](/docs/yaml/repo-preferences/app-branch-settings)
- [Configure your test suite](/docs/yaml/repo-preferences/pipeline/test-suite)
- [Set up build presets](/docs/yaml/repo-preferences/preset-service)
