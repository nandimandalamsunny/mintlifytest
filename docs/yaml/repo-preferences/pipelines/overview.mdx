...
<Steps>
  ...
  <Step title="Toggle Quality Gates">
    Enable or disable **[Code Quality](/docs/yaml/repo-preferences/pipelines/code-quality)** and **[Test Suite](/docs/yaml/repo-preferences/pipelines/test-suite)** execution for your repository.
  </Step>
