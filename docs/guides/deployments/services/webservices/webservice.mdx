...
<Steps>
  <Step title="Choose a Preset">
    ![Choose Webservice Preset](/images/guides/repo_preference/preset-2.png)

    The preset chooser shows a grid of service options. The **Webservice** tile is highlighted, described as a standard service for APIs or microservices. Click **Web Service** to continue.
  </Step>
  ...
  <Step title="Webservice — Environment Settings">
    ...
    The **QA** environment tab is selected. The left sidebar shows **Webservice** and **Variables** under Build & deployment workflow. The center panel shows the Webservice form:
  ...
  <Step title="Variables & Secrets">
    ![Variables & Secrets tab — QA environment](/images/guides/environment_settings/envsettings-2-1.png)

    The **QA** environment tab is selected with the **Secrets** sub-tab active. The left sidebar shows **Web service** and **Variables**. The center panel shows:
