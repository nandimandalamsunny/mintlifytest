...
<CardGroup cols={2}>
  <Card title="Deploy a Web App" icon="globe" href="/docs/guides/deployments/webapplications">
    Launch React, Next.js, or static sites with managed edge delivery.
  </Card>
  <Card title="API & Web Services" icon="server" href="/docs/guides/deployments/webservices/webservice">
    Deploy backend services with automated health checks and scaling.
  </Card>
  <Card title="Database Setup" icon="database" href="/docs/guides/deployments/databases">
    Provision and connect managed PostgreSQL or MySQL instances.
  </Card>
  <Card title="Secrets Management" icon="key" href="/docs/guides/deployments/secrets">
    Configure encrypted variables across your delivery pipeline.
  </Card>
</CardGroup>
