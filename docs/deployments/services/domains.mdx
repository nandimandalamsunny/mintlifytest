...
![Managed Domains](/docs/image-v2/deployments/domain/domain-1.png)
...
<Steps>
  <Step title="Add Domain">
    ...
    <div align="center">
      <img src="/docs/image-v2/deployments/domain/domain-2.png" width="200" />
    </div>
  </Step>
  ...
  <Step title="Live Verification">
    ...
    ![Domain Stats](/docs/image-v2/deployments/domain/domain-3.png)
  </Step>
</Steps>
...
- [Web Applications](/docs/deployments/services/web-applications)
