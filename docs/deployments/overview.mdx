...
To configure how your Git branches map to these environments, see [App Branch Settings](/docs/yaml/repo-preferences/app-branch-settings).

## Related

- [Services](/docs/deployments/services)
