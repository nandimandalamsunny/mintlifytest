...
<Frame>
  <img src="/docsv2/image-v2/agent/dev-agent/dev-agent-8.png" />
</Frame>
...
- [Get Started](/docsv2/ai-workflows/development-workflow/get-started) — Follow the step-by-step guide to activate your first workflow.
- [YAML Reference](/docsv2/yaml/overview) — Learn how to configure risk thresholds and service roots.
