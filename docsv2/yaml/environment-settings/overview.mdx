...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/docsv2/image-v2/yaml/env-settings/env-settings-1.png" width="450" />
</div>
...
- **[Pre-build Workflow](/docsv2/yaml/environment-settings/pre-build)**: Configure environment-specific pre-build automation, quality gates, and automated reviews.
- **[Services & Resources](/docsv2/yaml/environment-settings/services)**: Define resource specifications (CPU, Memory) and scaling policies per environment.
- **[Variables & Secrets](/docsv2/yaml/environment-settings/resource-specifications/variables)**: Manage environment variables and secure secrets for different deployment targets.
