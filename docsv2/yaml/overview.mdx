...
<Frame caption="The Revolte UI and revolte.yaml remain synchronized to support both visual configuration and Git-native workflows.">
  <img src="/docsv2/image-v2/yaml/yml-overview.png" alt="Revolte YAML Overview" />
</Frame>
...
- [Repository Preferences](/docsv2/yaml/repo-preferences/overview)
- [Environment Settings](/docsv2/yaml/environment-settings/services)
- [Deployments](/docsv2/deployments/services/overview)
- [Integrations](/docsv2/integrations/cloud/overview)
