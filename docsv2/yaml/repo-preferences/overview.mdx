---
title: "Repo Preferences Overview"
...
<CardGroup cols={2}>
  <Card title="App & Branch Settings" icon="code-branch" href="/docsv2/yaml/repo-preferences/app-branch-settings">
  ...
  <Card title="Prebuild Workflow" icon="microscope" href="/docsv2/yaml/repo-preferences/prebuild-workflow">
    Configure automated code reviews, PR summarization, and fix suggestions.
  </Card>
  <Card title="Pipeline" icon="gears" href="/docsv2/yaml/repo-preferences/pipeline">
    Automate code quality checks, style enforcement, and test suite execution.
  </Card>
  <Card title="Preset & Service" icon="layer-group" href="/docsv2/yaml/repo-preferences/preset-service">
...
- [Configure your test suite](/docsv2/yaml/repo-preferences/pipeline)
