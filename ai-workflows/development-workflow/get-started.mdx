...
<Steps>
  <Step title="Initialize Workflow Automation">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-1.png" width="600" />
    </Frame>
  </Step>
  ...
  <Step title="Access Automation Control">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-2.png" width="600" />
    </Frame>
  ...
  <Step title="Map Status Transitions">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-3.png" width="600" />
    </Frame>
  ...
  <Step title="Confirm Workflow Creation">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-4.png" width="600" />
    </Frame>
  ...
  <Step title="Tag Jira Tickets">
    ...
    <Info>
      See the [Jira Integration Guide](/integrations/project-management/jira#ticket-labeling) for detailed connection steps.
    </Info>

    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-5.png" width="600" />
    </Frame>
  ...
  <Step title="Execute Workflow">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-6.png" width="600" />
    </Frame>
  ...
  <Step title="Monitor Live Progress">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-7.png" width="600" />
    </Frame>
  ...
  <Step title="Review Execution Summary">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-8.png" width="600" />
    </Frame>
  ...
  <Step title="Inspect Implementation Plan">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-9.png" width="600" />
    </Frame>
  ...
  <Step title="Analyze Code Diffs">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-10.png" width="600" />
    </Frame>
  ...
  <Step title="Review and Merge">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-11.png" width="600" />
    </Frame>
  ...
  <Step title="Deploy to Preview">
    ...
    <Frame>
      <img src="/image-v2/agent/dev-agent/dev-agent-12.png" width="600" />
    </Frame>
